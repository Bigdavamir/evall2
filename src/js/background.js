	...
	"functions" : [
		{
			...
			"enabled": true,
			"pattern": "set(Node.textContent)"
		}, {
			"name": "Element.innerText",
			"enabled": true,
			"pattern": "set(HTMLElement.innerText)"
		}, {
			...
			"enabled": true,
			"pattern": "value(Element.setAttributeNS)"
		}, {
			...
			"enabled": true,
			"pattern": "set(HTMLIFrameElement.srcdoc)"
		}, {
			"name": "window.open",
			"enabled": true,
			"pattern": "window.open"
